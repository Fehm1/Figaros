...
{
    public class OurSalonMap : IEntityTypeConfiguration<OurSalon>
    {
        public void Configure(EntityTypeBuilder<OurSalon> builder)
        {
            ...
            builder.Property(a => a.LittleTitle).IsRequired();
            builder.Property(a => a.LittleTitle).HasMaxLength(200);
            builder.Property(a => a.Description).IsRequired();
            builder.Property(a => a.Description).HasMaxLength(500);
            builder.Property(a => a.RedirectUrl).IsRequired();
            builder.Property(a => a.RedirectUrl).HasMaxLength(150);
